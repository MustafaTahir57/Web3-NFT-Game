const styles = {
  ...
  // battleground page
  battlegroundContainer: 'min-h-screen bg-landing flex-col py-6 px-4',
  battleGroundsWrapper: 'flex-wrap mt-6 max-w-[1200px]',
  battleGroundCard: 'sm:w-[420px] w-full h-[200px] p-2 glass-morphism m-4 rounded-lg cursor-pointer battle-card',
